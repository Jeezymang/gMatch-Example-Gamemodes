local flagMaterial = Material( "gui/flag140x256.png" )
hook.Add( "HUDPaint", "GMatch:CTF_HUDPaint", function( )
	...
	for teamIndex, score in pairs ( currentScores ) do
		...
		render.PopFilterMag( )
		render.PopFilterMin( )
		draw.TexturedRect( 380 + ( currentIncrement * 55 ) + ( currentIncrement * 1.5 ), ScrH( ) - 75, 40, 64, flagMaterial, team.GetColor( teamIndex ) )
